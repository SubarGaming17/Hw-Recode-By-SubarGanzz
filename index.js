...
if(usePairingCode && !haikal.authState.creds.registered) {
		const phoneNumber = await question('Masukan Nomer Yang Aktif Awali Dengan 62 Recode : KazeyOfficial:\n');
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Creator : https://wa.me/6281818714377`})
